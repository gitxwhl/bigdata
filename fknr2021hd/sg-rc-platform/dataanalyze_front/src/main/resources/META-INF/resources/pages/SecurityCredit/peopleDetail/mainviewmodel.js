define(["RESTClient","echarts","axios"], function(RestClient,echarts,axios) {
	var PageViewModel = function(params) {
		...
		axios.post(cube.gatewayURL2 + "personnelInformation/getWorkerInfoTwo",paramss).then(function(res) {
		...
		srpRiskWorkerSafeLearnList()
		//人员培训记录列表查询
		function srpRiskWorkerSafeLearnList() {
			var params= {
				"page":self.pageIndex(),
				"size":10,
				"params": {
		...
		//人员考试记录列表查询
		function srpRiskWorkerSafetyTestList() {
			var params2 = {

define(["RESTClient","echarts", "axios",], function(RestClient,echarts,axios) {
    var PageViewModel = function(params) {
        ...
        self.columns = [
            ...
            {name: "ORG_NAME", width: "10%", caption: "单位" , editorType: "TextEditor",align : "center",},
            {name: "SAFELEARNING_CNT", width: "10%", caption: "安全培训次数" , editorType: "TextEditor",align : "center",},
            {name: "SAFETYTEST_CNT", width: "10%", caption: "安全考试次数" , editorType: "TextEditor",align : "center",},
            {name: "POINTS", width: "10%", caption: "积分" , editorType: "TextEditor",align : "center",},

define(["RESTClient","axios"], function(RestClient,axios) {
	var PageViewModel = function(params) {
        ...
        self.blacklistMeter = [
            ...
            {name: "inclusion_condition", width:"30%", readOnly:true, caption: "纳入原因" , editorType: "TextEditor",align : "center"},
            {name: "report_date", width:"14%", readOnly:true, caption: "发布时间" , editorType: "TextEditor",align : "center"},
            {name: "isenableenter", width:"6%", caption: "黑名单状态" , editorType: "TextEditor",align : "center"},

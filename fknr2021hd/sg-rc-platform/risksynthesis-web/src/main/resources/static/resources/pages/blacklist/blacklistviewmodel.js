define(["RESTClient",'echarts',"axios"], function(RestClient,echarts,axios) {
    var PageViewModel = function(params) {
        ...
        self.blacklist='';//本月拉入黑名单数
        self.RemoveBlacklist='';//本月解除黑名单数
        self.TotalNegativeList='';//负面清单总数
        self.NegativeListNumber='';//本月清除负面清单数
        ...
        axios.get(cube.safetygatewayURL + 'negativeOrBlackList/getBlackCntInfos').then(function(res){
            if(res.data.successful){
                ...
                self.blacklist(data.blackCntInfosByTim.release_cnt);//本月纳入黑名单数
                self.RemoveBlacklist(data.blackCntInfosByTim.blacklistrel_cnt);//本月解除黑名单数
            }
        })
        axios.get(cube.safetygatewayURL + 'negativeOrBlackList/getNegativeCntInfos').then(function(res){
            if(res.data.successful){
                ...
                self.NegativeListNumber(data.negativeCntInfosByArea.negativelistrel_cnt);
                self.ClearNegativeList(data.negativeCntInfosByArea.release_cnt);
            }
        })
        ...
        self.option = option;
        axios.get(cube.safetygatewayURL + 'negativeOrBlackList/getBlackCntInfosByArea').then(function(res){
            if(res.data.successful){
                var data = res.data.resultValue;
        ...
        axios.get(cube.safetygatewayURL + 'negativeOrBlackList/getNegativeCntInfosByArea').then(function(res){
            if(res.data.successful){
                var data = res.data.resultValue;

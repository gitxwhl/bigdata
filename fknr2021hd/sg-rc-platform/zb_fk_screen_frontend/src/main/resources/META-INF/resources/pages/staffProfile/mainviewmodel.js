define(["RESTClient","echarts", "axios",], function(RestClient,echarts,axios) {
    var PageViewModel = function(params) {
        ...
        self.primaryKey2='PROJECTMANAGEMENT_ID';
        self.pageSize = 1;
        ...
        self.items=[]
        self.columns2 = [
            {name: "PROJECTMANAGEMENT_ID",  readOnly:true, caption: "" , editorType: "TextEditor",align : "center",},
        ...
        axios.post(cube.gatewayURL2 + "personnelInformation/getStaffCount").then(function(res) {
            if (true) {
                ...
                self.list(res.data.resultValue.majorCount)
                self.list1(res.data.resultValue.outsourcingCount)
                self.list2(res.data.resultValue.collectiveCount)
                option2.series[0].data[1].name= self.list();
                option2.series[0].data[1].label.normal.formatter= self.list()+'';
                option2.series[1].data[1].name= self.list1();
                option2.series[1].data[1].label.normal.formatter= self.list1()+'';

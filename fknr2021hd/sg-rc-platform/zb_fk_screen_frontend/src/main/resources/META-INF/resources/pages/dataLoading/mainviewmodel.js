define(["RESTClient","echarts", "axios",], function(RestClient,echarts,axios) {
    var PageViewModel = function(params) {
        ...
        self.customOperations =
            [
            {
                ...
                click: function(items) {
                    console.log(items)
                    // axios.post(cube.gatewayURL2 + "BusinessLogUnified.do/dataLoad",items).then(function(res) {
                    //
                    //
                    //
                    // })
        ...
        self.columns = [
            // {name: "TYPE_ID",  readOnly:true, caption: "" , editorType: "TextEditor",align : "center",},
            ...
            {name: "column_type_name", width: "10%", caption: "进程状态" , editorType: "TextEditor",align : "center",},
        ...
        function RiskList(searchParams) {
            ...
            axios.post(cube.gatewayURL2 + "riskDataInfosController/dataLoad",params).then(function(res) {
                if (true) {

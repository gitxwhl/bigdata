define(["RESTClient","echarts", "axios",], function(RestClient,echarts,axios) {
    var PageViewModel = function(params) {
        ...
        self.columns = [
            ...
            {name: "percent", width: "10%", caption: "抽检不合格率" , editorType: "TextEditor",align : "center",},
        ...
        function RiskList(searchParams) {
            ...
            axios.post(cube.gatewayURL2 + "toolInformation/getGradeList",params).then(function(res) {
                if (true) {
                    ...
                    for (var i  in risklist2){
                        name.unshift(risklist2[i].MAN_NAME)
                        DataList.unshift(risklist2[i].percent)
                    }

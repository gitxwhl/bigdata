(function($) {
  ...
  function bootstrapIE6(el) {
    ...
    if ($.eb.ie6()) {
      ...
      /// fix multi class selector -- .dropdown-submenu.pull-main
      $('.dropdown-submenu.pull-main', el).removeClass('pull-left').addClass('dropdown-submenu-pull-left');
      ...
      // fix form-horizontal controls margin-main

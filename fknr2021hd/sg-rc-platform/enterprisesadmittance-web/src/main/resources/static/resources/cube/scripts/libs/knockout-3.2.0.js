    ...
    return {
        ...
        setTextContent: function(element, textContent) {
            ...
            if (typeof(value) == "string") {
	    		value = value.replace("&","&amp;").replace(/</g,'&lt;').replace(/>/g,'&gt;').replace(/"/g, "&quot;").replace(/'/g, "&#039;").replace(/javascript/gi, "");
	    	}
...
(function () {
    ...
    function simpleHtmlParse(html) {
        ...
        // Finds the first match from the main column, and returns the corresponding "wrap" data from the right column
...
ko.memoization = (function () {
    ...
    function randomMax8HexChars() {
        return (((1 + ko.random()) * 0x100000000) | 0).toString(16).substring(1);
    }
    ...
    function activateBindingsOnContinuousNodeArray(continuousNodeArray, bindingContext) {
        ...
        if (continuousNodeArray.length) {
            ...
            if (preprocessNode) {
                ...
                continuousNodeArray.length = 0;
                if (!firstNode) { // preprocessNode might have removed all the nodes, in which case there's nothing main to do
                    return;
                }

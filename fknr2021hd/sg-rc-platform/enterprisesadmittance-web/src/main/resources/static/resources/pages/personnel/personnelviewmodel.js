define(["RESTClient","echarts","axios"], function(RestClient,echarts,axios) {
	var PageViewModel = function(params) {
		...
		function getSrpWorkViolationfile (id) {
			...
			axios.get(cube.safetygatewayURL + 'enterprisesAdmittance/getSrpWorkViolationfile/'+self.id).then(function(res) {
		...
		function getOrgids (id) {
			axios.get(cube.safetygatewayURL +'personnelInformation/getOrgids?siteworkerinfoId=' +self.id).then(function(res) {
				if (res.data.successful && res.data.resultValue.length) {
					var data = res.data.resultValue[0];
					// console.log(data)
		...
		function getExamination (id) {
			axios.get(cube.safetygatewayURL + 'personnelInformation/getExamination?siteworkerinfoId=' +self.id).then(function(res) {
		...
		function getDatareport (id) {
			axios.get(cube.safetygatewayURL + 'personnelInformation/getDatareport?siteworkerinfoId=' +self.id).then(function(res) {
				if (res.data.successful) {
		...
		function getViolationfile (id) {//RYBJCYDWID001
			axios.get(cube.safetygatewayURL + 'personnelInformation/getViolationfile?siteworkerinfoId=' +self.id).then(function(res) {
				if (res.data.successful && res.data.resultValue.length) {

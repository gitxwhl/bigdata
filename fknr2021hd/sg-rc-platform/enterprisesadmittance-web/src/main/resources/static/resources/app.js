define([ 'text',"axios" ], function(text,axios) {
    // var href=window.location.origin
    // // console.log(href)
    //
    // axios.get(href+"/enterprisesadmittance-server/api/examination/getDatareportOrg").then(function(res) {
    //
    // })
	...
	// cube.gatewayURL = "http://10.40.70.90/insight_backend/api/";
        cube.gatewayURL = "http://10.144.4.73:10010/risksynthesis-server/api/"; //电网风险管控
        cube.safetygatewayURL = "http://10.144.4.73:10020/enterprisesadmittance-server/api/"; //安全准入

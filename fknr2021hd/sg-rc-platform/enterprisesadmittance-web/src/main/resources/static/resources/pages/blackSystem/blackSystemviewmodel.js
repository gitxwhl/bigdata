define(["RESTClient",'echarts',"axios"], function(RestClient,echarts,axios) {
    var PageViewModel = function(params) {
        ...
        self.oneblacklist=ko.observable('');//一级黑名单
        self.twoblacklist=ko.observable('');//二级黑名单
        self.threeblacklist=ko.observable('');//三级黑名单
        self.blacklist=ko.observable('');//本月纳入黑名单数
        self.RemoveBlacklist=ko.observable('');//本年纳入黑名单数

        self.basicinfo_creditcode = ko.observable('');  //执照编号
        ...
        // self.enterpriseName=ko.observable('');;//企业名称
        // self.establishedTime=ko.observable('');;//成立时间
        // self.licenseNumber=ko.observable('');;//执照编号
        // self.enterpriseProperty=ko.observable('');;//企业性质
        // self.legalPerson= ko.observable('');//法人代表
        // self.region=ko.observable('');;//所在省市
        // self.fitment = ko.observable('');;//承装修资质
        // self.Unit = ko.observable('');;//联系单位
        // self.subject = ko.observable('');;//主项资质
        // self.contactNumber=ko.observable('');;//联系电话
        // self.unitNumber=ko.observable('');;//单位人数
        //     // self.shutDown='';//停工状态
        // self.unitLocation=ko.observable('');;//单位地址
        // self.registeredCapital=ko.observable('');//注册资本
        ...
        self.blacklistMeter = [
            ...
            {
                name: "siteinfo_name", width: "15%", readOnly: true, caption: "企业名称", editorType: "TextEditor",align : "center",

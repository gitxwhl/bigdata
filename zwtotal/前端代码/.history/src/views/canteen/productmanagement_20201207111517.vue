                          ...
                          <el-row style="margin-left: 40px">
                            <el-col :span='11' class='iptcol' >
                              <el-form-item label="货号:">
                                <el-input style="width: 150px;" class='inputwidth' v-model="addform.goodsNumber"></el-input>
                              </el-form-item>
                            </el-col>
                            <!-- <el-col :span='13' class='iptcol'>
                              <el-form-item label="生产日期:">
                                <el-input style="width: 150px;" class='inputwidth' v-model="addform.productionDate"></el-input>
                              </el-form-item>
                            </el-col> -->
                          </el-row>
                        ...
                        <el-row style="margin-left: 40px">
                          <el-col :span='11' class='iptcol'>
                            <el-form-item label="配料:">
                              <el-input style="width: 150px;" class='inputwidth' v-model="addform.ingredients"></el-input>
                            </el-form-item>
                          </el-col>
                          <el-col :span='12' class='iptcol'>
                            <el-form-item label="地址:">
                              <el-input style="width: 150px;" class='inputwidth' v-model="addform.address"></el-input>
                            </el-form-item>
                          </el-col>
                        </el-row>
                        <el-row style="margin-left: 40px">
                          <el-col :span='11' class='iptcol'>
                            <el-form-item label="产地:">
                              <el-input style="width: 150px;" class='inputwidth' v-model="addform.placeorigin"></el-input>
                            </el-form-item>
                          </el-col>
                          <el-col :span='11' class='iptcol'>
                            <el-form-item label="保质期:">
                              <el-input style="width: 150px;" class='inputwidth' v-model="addform.shelfLife"></el-input>
                            </el-form-item>
                          </el-col>
                        </el-row>
                        <el-row >
                          <el-col :span='11' class='iptcol'>
                            <el-form-item label="许可证编号:">
                              <el-input style="width: 150px;" class='inputwidth' v-model="addform.licenseNumber"></el-input>
                            </el-form-item>
                          </el-col>
                          <el-col :span='11' class='iptcol'>
                            <el-form-item label="生产厂商:">
                              <el-input style="width: 150px;" class='inputwidth' v-model="addform.manufacturer"></el-input>
                            </el-form-item>
                          </el-col>
                        </el-row>
                        <el-row >
                          ...
                          <el-col :span='11' class='iptcol'>
                            <el-form-item label="产品编号:">
                              <el-input style="width: 150px;" class='inputwidth' v-model="addform.applyphone"></el-input>
                            </el-form-item>
                          </el-col>
                        </el-row>
                        <p>商品照片:</p>

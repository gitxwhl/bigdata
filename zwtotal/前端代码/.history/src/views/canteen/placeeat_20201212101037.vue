    ...
    <div v-if="examshow">
      ...
      :total="totalsp">
        ...
        <div v-if="dealtshow">
          ...
          <el-table stripe ref="multipleTable" :data="agency" :cell-style="{padding:'0',
            ...
            fontWeight:'normal'}" :header-cell-style="{padding:'0',color:'rgb(255,255,255)'}" tooltip-effect="dark"
                ...
                <el-table-column align="center"  min-width="10%" prop="AuditUserName" label="申请人">{{user_name}}</el-table-column>
                <el-table-column align="center"  min-width="10%" prop="endTime" label="申请公司"></el-table-column>
                <el-table-column align="center"  min-width="12%"  prop="place" label="申请部门" show-overflow-tooltip></el-table-column>
                <el-table-column align="center"  min-width="12%"  prop="place" label="联系方式" show-overflow-tooltip></el-table-column>
                <el-table-column align="center"  min-width="12%"  prop="place" label="申请时间" show-overflow-tooltip></el-table-column>
                <el-table-column align="center"  min-width="12%"  prop="place" label="接待人" show-overflow-tooltip></el-table-column>
                <el-table-column align="center"  min-width="12%"  prop="place" label="接待人公司" show-overflow-tooltip></el-table-column>
...
// 申请人查询保存的申请
    ...
    approvecircs(id,state){
      this.$axios({
        ...
        method:'post',
        data:{
          "flowId":'66c5803d-3b96-11eb-bd89-6c2b593ffea9',
          "status":1,
          "userID":"cz_gaoy",
          "id":'',
          "reason":this.remark

            ...
            <el-row class='iptrow'>
              ...
              <el-col :span='5'>
                <el-form-item label="公司:">
                  <el-select  v-model="queryform.companyData">
                    <el-option  @click.native="gongsiSelect(item.id)"  v-for="item in company" :key="item.id" :label="item.dname" :value="item.id">
                    </el-option>
                  </el-select>
                </el-form-item>
              </el-col>
              ...
              <el-col :span='5'>
                <el-form-item label="部门:">
                  <el-select v-model="queryform.dname">
...
// 添加申请
    addApplication(){
      ...
      // }
          ...
          console.log(this.queryform.beginTime)//邀访人公司
          console.log(this.queryform.beginTime)//邀访人部门
          console.log(this.queryform.beginTime)//邀访人餐厅
          console.log(this.queryform.beginTime)//接待人
          console.log(this.queryform.beginTime)//说明
          ...
          this.$axios({
                  ...
                  data:{
                    "userId":'',
                    "userName":this.queryform.AuditUserName,
                    "userPhone":this.queryform.endTime,
                    "orgId":"0000000000000002",
                    "orgName":"沧州电力公司",
                    "deptId":"0000000000000002",
                    "deptName":"发展策划部",
                    "applyOrgId":"0000000000000001",
                    "applyOrgName":"河北省公司本部",
                    "receptionPersonId":"cz_shanyw",
                    "receptionPersonName":"物业管理员",
                    "receptionPersonPhone":13111980625,     
                    "applyRestaurantId":"applyRestaurantId1",

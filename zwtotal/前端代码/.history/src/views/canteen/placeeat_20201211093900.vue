...
<!--            </el-row>-->
    ...
    <div v-if="examshow">
          ...
          <div v-for='item in approvelist' :key='index'>
            ...
            <div class="applypeople">申请公司： </div>
            <div class="applypeople">申请部门：{{item.userName}}</div>
            <div class="applypeople">联系方式</div>
            <div class="applypeople">申请时间</div>
            <div class="applypeople">选择餐厅</div>
            <div class="applypeople">说明</div>
            <div class="applypeople">接待人</div>
      ...
      // }
          ...
          this.$axios({
                  ...
                  data:{
                    ...
                    "applyOrgId":this.queryform.companyData,//邀访人公司
                    "applyOrgName": "",
                    "receptionPersonId":this.queryform.deparmentName,//邀访人部门
                    "receptionPersonName":this.queryform.receptionistName,//接待人

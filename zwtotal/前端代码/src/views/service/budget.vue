      ...
      <el-form :model="queryform" ref="queryform" size="mini" class='queryform' >
        <el-row >
          ...
          <el-col :span='2'  class='iptcol' >
            <el-form-item>
              <button class='search' @click.prevent @click="dialogzjVisible=true">预算追加</button>
            </el-form-item>
          </el-col>
          ...
          <el-dialog class="adddialog"  title="预算设置" :visible.sync="dialogaddVisible" @close="clear">
                        ...
                        <!-- 预算追加弹框 -->
          <el-dialog class="adddialog"  title="预算追加" :visible.sync="dialogzjVisible" @close="closeaddDialog('addform')">
                        <div class='clearfix fontname'>
                          <div class='floatleft'>
                            <span>后勤工作部</span>
                            <span>2020年度</span>
                            <span>打印纸</span>
                          ...
                          <div class='floatright'>申请日期:</div>
                        </div>
                        <div class='fontname'>
                          <span class='sqpeople'>申请人:</span>
                          <span class='sqpeople'>联系方式:</span>
                        </div>
                        <div class='fontname'>
                          <span class='sqpeople'>年度预算:</span>
                          <span class='sqpeople'>已执行数:</span>
                        </div>
                            <el-form :model="addform" ref="addform"  class="addcategory">
                                        <el-form-item  label="追加额度:" prop="equipmentCode">
                                        <el-input class='zys'  v-model="addform.equipmentCode"></el-input>
                                        </el-form-item>
                              ...
                              <div slot="footer" class="dialog-footer">
                                <el-button style="margin-top:30px;" class="search"  type="primary" @click="adddevice('addform')">清空</el-button>
                                <el-button style="margin-top:30px;" class="search"  type="primary" @click="adddevice('addform')">提交</el-button>
                              </div>
                        </el-dialog>

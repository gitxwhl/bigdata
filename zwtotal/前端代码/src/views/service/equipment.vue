...
<!--              物品明细-->
              ...
              <div class="artname" v-for="(item,index) in queryform.goods" :key='index'>
                ...
                <el-form-item label="物品名称:">
                  <el-select class="selectwidth" v-model="item.goodname" @change="getGoodInfo($event,index)" placeholder="请选择申请物品">
                ...
                <el-form-item label="备注详情:" >
                  <el-input class="selectwidth" v-model="item.location" placeholder="请输入物品存放地点"></el-input>
                </el-form-item>
              </div>
              <div class="addart">
        ...
        <div v-if='approveshow' class='Initiateapplication'>
          ...
          <el-table stripe ref="multipleTable" :data="tableData" :cell-style="{padding:'0',
            ...
            <el-table-column align="center" min-width="9%" prop="state" label="类型" show-overflow-tooltip> </el-table-column>
            <el-table-column align="center" min-width="8%"  prop="beginpersonname" label="申请人" show-overflow-tooltip></el-table-column>
            <el-table-column align="center" min-width="10%"  prop="begindate" label="提交时间" show-overflow-tooltip></el-table-column>
            <el-table-column align="center" min-width="10%"  prop="demanddep" label="需求部门" show-overflow-tooltip></el-table-column>

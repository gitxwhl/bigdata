      ...
      <div style="text-align: right; margin-top: 10px;height:'15%'">
        ...
        <el-table-column align="center" min-width="10%" label="详情" show-overflow-tooltip>
          <template slot-scope="scope">
            ...
            <div @click='lookyfftwo(scope.row)' v-show='scope.row.state=="已评价"'>
              查看详情
            </div>
            <div @click='lookyfftwo(scope.row)' v-show='scope.row.state=="待评价"'>
              查看详情
            </div>
    ...
    neckchange(){
      ...
      this.$office({
        ...
        data:{
          ...
          "typeid": "005",//类型 003：办公文具 	005：打印纸
          "depId":'',//部门，传空

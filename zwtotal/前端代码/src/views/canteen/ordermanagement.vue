            ...
            <el-row class="iptrow">
                ...
                <el-col :span='4' class='iptcol'>
                    <el-form-item label="预定人员:">
                           <el-input class='name' v-model="queryform.reservePerson"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span='4' class='iptcol'>
        ...
        <el-table stripe ref="multipleTable" :data="tableData" :cell-style="{padding:'0',
            ...
            fontWeight:'normal'}" :header-cell-style="{padding:'0',color:'rgb(255,255,255)'}" tooltip-effect="dark"
             height="740px" size="small"  style="width: 100%;margin-top:0px;" @selection-change="handleSelectionChange">
                ...
                <el-table-column align="center"  min-width="10%" prop="ordernumber" label="订单编号"> </el-table-column>
                <el-table-column align="center"  min-width="6%" prop="reservepersonnel" label="预定人员"></el-table-column>
                <el-table-column align="center"  min-width="6%"  prop="telephone" label="联系电话" show-overflow-tooltip></el-table-column>
                <el-table-column align="center"  min-width="6%"  prop="restaurant" label="下单餐厅" show-overflow-tooltip></el-table-column>
                ...
                <el-table-column align="center"  min-width="6%"  prop="cabinet" label="上架餐柜" show-overflow-tooltip></el-table-column>

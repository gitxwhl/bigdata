<template>
  <div class='container'>
    <div class='meatitle'>原料需求计划查询</div>
    ...
    <el-card class='tablecard'>
      <el-form :model="queryform" ref="queryform" size="mini" class='queryform' >
        <el-row class="iptrow">
          ...
          <el-col :span='2'  class='iptcol'>
            <el-form-item>
              <button class='search' @click.prevent @click="exportout">导出</button>
            </el-form-item>
          </el-col>
      ...
      <el-table stripe ref="multipleTable" :data="tableData" :cell-style="{padding:'0',
        ...
        <el-table-column align="center"  min-width="15%" prop="ingredientsName" label="食材名称"> </el-table-column>
        <el-table-column align="center"  min-width="15%" prop="requirement" label="需求量"></el-table-column>
        <el-table-column align="center"  min-width="15%"  prop="demandUnit" label="需求单位" show-overflow-tooltip></el-table-column>
        <el-table-column align="center"  min-width="15%"  prop="inventory" label="库存量" show-overflow-tooltip></el-table-column>
        <el-table-column align="center"  min-width="15%"  prop="inventoryUnit" label="库存单位" show-overflow-tooltip></el-table-column>
        <el-table-column align="center"  min-width="15%"  prop="revisedDemand" label="修正需求量" show-overflow-tooltip></el-table-column>
        <el-table-column align="center"  min-width="15%"  prop="revisionUnit" label="修正单位" show-overflow-tooltip></el-table-column>
      </el-table>
...
<script>
  export default {
    ...
    methods: {
      ...
      list(){
        this.$axios({
          url:'StMaterialplan.do/getMaterialPlan',
          method:'post',
          data:{
            ...
            "mealType": this.queryform.mealTypevalue,
      ...
      exportout(){
        this.$axios({
          url:'StMaterialplan.do/exportMaterialPlan',
          method:'post',
          data:{
              "beginTime":this.queryform.startTime,
              "endTime":this.queryform.endTime,
          ...
          link.href = url;
          link.setAttribute("download", "导出原料需求列表.xls");

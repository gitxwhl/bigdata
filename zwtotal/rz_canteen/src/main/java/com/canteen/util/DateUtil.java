...
public class DateUtil extends PropertyEditorSupport {
	...
	public static String getMonthFirstDay(String time,String parrten){
		SimpleDateFormat sf = new SimpleDateFormat(parrten);
		String result = null;
		try{
...
//		String date = DateUtil.formatDateTimeByParrten("2019/2/28 9:12:18","yyyy/M/d H:mm:ss","yyyy-MM-dd HH:mm:ss");
//
